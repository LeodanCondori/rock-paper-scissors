...
function gameLogic(optionPlayer, optionComputer){
...
function whoWins(scoreComputer, scorePlayer){
...
if (wannaPlay === "y"){
    ...
    while (!isThereWinner){
        ...
        gameLogic(optionPlayer,optionComputer);
    ...
    whoWins(scoreComputer,scorePlayer);
